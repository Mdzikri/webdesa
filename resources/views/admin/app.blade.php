...
<body data-background-color="dark">
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="dark2">
				...
				<a href="/dashboard" class="logo text-white">
					<img style="height: 50px; width: 50px;" src="https://upload.wikimedia.org/wikipedia/commons/a/ad/Kemendes_Logo.png" class="navbar-brand">  Desa
				</a>
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="{{asset('assets/img/arip.png')}}" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Hizrian</h4>
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Pusat Pangkalan Data Desa </h5>
							</div>
	...
	<script>
           ...
           // CKEDITOR.config.uiColor = '#1a2035';
    </script>
	<script>
